...
export const resourcesData = [
  ...
  },
  {
    ...
    content: `
      ...
      <h3>The Grind</h3>
      <p>In Egypt, Joseph didn't sulk. He worked. He became the top manager for Potiphar. Then, falsely accused, he got thrown in prison. Did he quit? No. He started organizing the prison. He used his gifts even when no one was watching and no one was paying him.</p>
      <h3>The Palace</h3>
      <p>One dream changed everything. Pharaoh needed answers, and Joseph was ready. In one day, he went from prisoner to Prime Minister. But the real climax wasn't the power; it was when his starving brothers showed up begging for food. He had the power to kill them, but he chose to save them.</p>
      <div class="bg-white/10 p-6 rounded-xl border-l-4 border-brand-accent my-8">
        <h4 class="font-bold text-white mb-2">💡 The Takeaway</h4>
        <p class="text-sm">"You intended to harm me, but God intended it for good." Your setbacks are just setups for a comeback.</p>
      </div>
    `,
  },
  {
    ...
    content: `
      ...
      <h3>Don't Wear Someone Else's Armor</h3>
      <p>The King tried to put his heavy armor on David. It didn't fit. It looked ridiculous. David took it off. He picked up five smooth stones—weapons he actually knew how to use. Lesson? Be you. God can't use your fake persona; He uses your authentic self.</p>
      <h3>The Shot</h3>
      <p>It wasn't just a lucky shot. It was confidence. David didn't run away; the Bible says he <em>ran quickly toward the battle line</em>. He knew the battle wasn't his to win; it was the Lord's.</p>
      <div class="bg-white/10 p-6 rounded-xl border-l-4 border-brand-accent my-8">
        <h4 class="font-bold text-white mb-2">💡 The Takeaway</h4>
        <p class="text-sm">Your giant isn't too big for God. Stop looking at the size of the problem and start looking at the size of your God.</p>
      </div>
    `,
  },
  {
