...
const RSVPManager = () => {
  ...
  // ✅ UPDATED: PDF GENERATOR WITH RIGHT-ALIGNED TITLE
  const handlePrintAttendance = () => {
    ...
    const eventDate = selectedEvent.event_date?.toDate
      ? selectedEvent.event_date.toDate().toLocaleDateString("en-US", {
          weekday: "long",
          year: "numeric",
          month: "long",
          day: "numeric",
    ...
    const rows = filteredRsvps
      ...
      <tr>
        ...
        <td style="padding: 10px; border: 1px solid #ddd;">${
          rsvp.email === "walkin@noemail.com" ? "N/A (Walk-in)" : rsvp.email
        }</td>
        <td style="padding: 10px; border: 1px solid #ddd;">${
          rsvp.phone || "-"
        }</td>
    ...
    const html = `
      <html>
        <head>
          <title>Attendance - ${selectedEvent.title}</title>
          <style>
            ...
            h1 { margin: 0; font-size: 24px; text-transform: uppercase; color: #000; letter-spacing: 1px; }
            .sub-title { font-size: 10px; text-transform: uppercase; letter-spacing: 2px; color: #666; margin-bottom: 5px; font-weight: bold; }
            .meta { font-size: 13px; color: #555; line-height: 1.6; }
            
            table { width: 100%; border-collapse: collapse; font-size: 12px; margin-top: 10px; }
            th { background: #f0f0f0; padding: 12px; border: 1px solid #999; text-align: left; font-weight: bold; text-transform: uppercase; }
        ...
        <body>
          <div class="header">
            <div class="header-left">
              ...
              <div class="meta">
                ...
                <strong>TOTAL PARTICIPANTS:</strong> ${filteredRsvps.length}
              </div>
            </div>
            
            <div class="header-right">
              <div class="sub-title">YOUTH XTREME</div>
              <h1>Attendance - ${selectedEvent.title}</h1>
            </div>
          </div>
          ...
          <div style="margin-top: 40px; font-size: 11px; text-align: center; color: #888; border-top: 1px solid #eee; padding-top: 10px;">
            Generated by Youth Xtreme Admin System • ${new Date().toLocaleString()}
          </div>
